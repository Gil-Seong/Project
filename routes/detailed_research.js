...
route.get('/detailed_research',function(req,res){
  ...
  var sql ='SELECT user.userid, name, gender, DATE_FORMAT(birthday,"%Y-%m-%d") birthday, phonenumber, email, address, class_title, class_subject, class_student, class_style, experience, expense, self_introduce FROM user, class where cid="'+cid+'" and user.userid=class.userid';
